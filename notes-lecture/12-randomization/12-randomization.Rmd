...
.footnote[
.pink[†] Don't worry, Fisher was knighted for more than this experiment.
]
...
There was also [an issue](https://datacolada.org/99) with the way Young calculated standard errors
<br>(coincidentally related to finite-sample corrections).
...
.ex[*E.g.*,] Use the point estimates associated with the 2.5.super[th] and 97.5.super[th] percentiles to construct a 95% confidence interval.
