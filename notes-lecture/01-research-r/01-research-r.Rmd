...
- Welcome, check in, [admin](https://github.com/edrubin/EC607S21), and survey
...
- No class Wednesday (do assignment)
...
.footnote[
.tran[blah]
<br>.pink[†] Also: Machine learning (_e.g._, my [ML and econometrics course here at UO](https://github.com/edrubin/EC524W20))
]
...
.hi[Lab] Practice applying our in-class content in .mono[R] with Philip/me. Attend.

.hi[Problem sets] 3+ problem sets mixing theory and applications in .mono[R].

.hi[Other grades] Project plus take-home final.
...
pagedown::chrome_print("01-research-r.html", output = "01-research-r.pdf")
```
